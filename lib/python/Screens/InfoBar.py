...
from Screens.InfoBarGenerics import InfoBarShowHide, \
	...
	InfoBarEPG, InfoBarSeek, InfoBarInstantRecord, InfoBarESIteam, InfoBarResolutionSelection, InfoBarAspectSelection, \
...
class InfoBar(InfoBarBase, InfoBarShowHide,
	...
	InfoBarInstantRecord, InfoBarAudioSelection, InfoBarRedButton, InfoBarTimerButton, InfoBarESIteam, InfoBarResolutionSelection, InfoBarAspectSelection, InfoBarVmodeButton,
	...
	def __init__(self, session):
		...
		for x in HelpableScreen, \
				...
				InfoBarNumberZap, InfoBarChannelSelection, InfoBarMenu, InfoBarEPG, InfoBarRdsDecoder, \
				InfoBarInstantRecord, InfoBarAudioSelection, InfoBarRedButton, InfoBarTimerButton, InfoBarUnhandledKey, InfoBarLongKeyDetection, InfoBarESIteam, InfoBarResolutionSelection, InfoBarVmodeButton, \
